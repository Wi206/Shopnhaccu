...
namespace musicShop.Controllers
{
    ...
    public class KhachHangController : Controller
    {
        ...
        public KhachHangController (musicShopDbContext context, IHttpContextAccessor httpContextAccessor, IMailLogic mailLogic)
        {
            _context = context;
        ...
        public async Task<IActionResult> DatHang (DatHang datHang)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    mailInfo.Subject = "Đặt hàng thành công tại HGshop.Com.Vn";
