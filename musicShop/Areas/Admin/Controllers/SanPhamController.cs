...
namespace musicShop.Areas.Admin.Controllers
{
    ...
    public class SanPhamController : Controller
    {
        ...
        public SanPhamController (musicShopDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        {
            var musicShopDbContext = _context.SanPham.Include(s => s.HangSanXuat).Include(s => s.LoaiSanPham);
        ...
        public async Task<IActionResult> DeleteConfirmed (int id)
        {
            ...
            {
                return Problem("Entity set 'musicShopDbContext.SanPham'  is null.");
            }
            var sanPham = await _context.SanPham.FindAsync(id);
            if (sanPham != null)
            {
