...
namespace musicShop.Areas.Admin.Controllers
{
    ...
    public class NguoiDungController : Controller
    {
        ...
        public NguoiDungController (musicShopDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index ()
        {
            return _context.NguoiDung != null ?
                        ...
                        Problem("Entity set 'musicShopDbContext.NguoiDung'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed (int id)
        {
            ...
            {
                return Problem("Entity set 'musicShopDbContext.NguoiDung'  is null.");
            }
            var nguoiDung = await _context.NguoiDung.FindAsync(id);
            if (nguoiDung != null)
            {
