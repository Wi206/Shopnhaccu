...
namespace musicShop.Areas.Admin.Controllers
{
    public class DatHang_ChiTietController : Controller
    {
        ...
        public DatHang_ChiTietController (musicShopDbContext context)
        {
            _context = context;
        }
        ...
        {
            var musicShopDbContext = _context.DatHang_ChiTiet.Include(d => d.DatHang).Include(d => d.SanPham);
        ...
        public async Task<IActionResult> DeleteConfirmed (int id)
        {
            ...
            {
                return Problem("Entity set 'musicShopDbContext.DatHang_ChiTiet'  is null.");
            }
            var datHang_ChiTiet = await _context.DatHang_ChiTiet.FindAsync(id);
            if (datHang_ChiTiet != null)
            {
