...
namespace musicShop.Areas.Admin.Controllers
{
    ...
    public class TinhTrangController : Controller
    {
        ...
        public TinhTrangController (musicShopDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index ()
        {
            return _context.KhachHang != null ?
                        ...
                        Problem("Entity set 'musicShopDbContext.KhachHang'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed (int id)
        {
            ...
            {
                return Problem("Entity set 'musicShopDbContext.KhachHang'  is null.");
            }
            var tinhTrang = await _context.KhachHang.FindAsync(id);
            if (tinhTrang != null)
            {
